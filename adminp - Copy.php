        ...
        <header  class="mb-auto">
          <div>
            ...
            <nav class="nav nav-masthead justify-content-center float-md-end">
              <a class="nav-link fw-bold py-1 px-0" aria-current="page" href="user_details.php">User Details</a>
              <a class="nav-link fw-bold py-1 px-0" href="orderdetails.php">Order Details</a>
              <a class="nav-link fw-bold py-1 px-0" href="pro_details.php">Product Details</a>
              <a class="nav-link fw-bold py-1 px-0" href="pro.php">Add Products</a>
      ...
      <div class="col">
        <div class="card card-cover overflow-hidden text-bg-dark rounded-4 shadow-lg">
          <div class="d-flex flex-column p-5 pb-3 text-shadow-1" style="height:450px;width:auto;">
            <img src="save\\<?php echo $r[2];?>" style="height:200px;width:100%;"><br>
